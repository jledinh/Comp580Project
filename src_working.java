...
public class StreamingRecognizeClient2 {
  ...
  public void recognize() throws InterruptedException, IOException {
   ...
   //           if (transcript.toLowerCase().indexOf("yes") >= 0) {
                //testList.
   //         	  wordsList.add(testList.get(i-1));
    //          }
              if (transcript.toLowerCase().indexOf("no") >= 0) {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //   	System.out.println("Hi, my name is " + wordsList.get(0));
